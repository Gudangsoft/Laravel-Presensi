                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            autocomplete="off"
                            class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200 @error('captcha_answer') border-red-400 focus:ring-red-400 focus:border-red-400 @enderror"
                        >
                    ...
                    {{-- Google Login --}}
                    <a href="{{ route('google.admin.redirect') }}"
                       class="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-xl px-4 py-2.5 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 shadow-sm">
